...
int main(int argc, char* argv[]) {
    ...
    int n = atoi(argv[1]);          // number of threads; there are n - 1 workers ; recall argv[0] is ./<executable_name>
    ...
    // write output module
    create_output(SERIAL, checksums_array, numSources, n, T, W, trial_num);
